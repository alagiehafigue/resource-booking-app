...
export default function MyBookings() {
  ...
  const askForLogout = () => {
    setConfirmState({
      title: "Log out now?",
      message:
        "You will be signed out of the resource booking app on this browser.",
  ...
  const askToCancelBooking = (bookingId) => {
    setConfirmState({
      ...
      message:
        "This booking will be cancelled immediately. You can create a new booking again later if needed.",
      ...
      <main className='mb-main'>
        <section className='mb-hero'>
          <div className='mb-hero__copy'>
            ...
            <h1>My Bookings</h1>
            <p>
              Track every request, check approval status, and manage your
              reservations in one place.
            </p>
          </div>
          <div className='mb-hero__actions'>
            <Link to='/home' className='mb-btn mb-btn--ghost'>
              Browse Resources
            </Link>
            <button
              type='button'
        ...
        <section className='mb-content'>
          <div className='mb-toolbar'>
            <div>
              <h2>
                {session.name ? `${session.name}'s bookings` : "Your bookings"}
              </h2>
              <p>
          ...
          {banner && (
            <div className='mb-banner mb-banner--success'>{banner}</div>
          )}
          ...
          {loading ? (
            ...
            <div className='mb-empty'>
              ...
              <p>
                Start from the resources page and your reservations will appear
                here.
              </p>
              <Link to='/home' className='mb-btn mb-btn--primary'>
                Go to Resources
              </Link>
            </div>
          ) : (
                ...
                return (
                  <article key={booking.booking_id} className='mb-card'>
                    <div className='mb-card__top'>
                      ...
                      <span className={`mb-status mb-status--${tone}`}>
                        {booking.status}
                      </span>
                    </div>
